...
app.get("/products", async (req, res) => {
  // ১. req.query থেকে পেজ নম্বর এবং লিমিট নেওয়া
...
ধরা যাক আপনার ডেটাবেসে মোট **৫০টি** প্রোডাক্ট আছে।
...
যদি একটি কুয়েরির রেজাল্টের ওপর ভিত্তি করে আপনাকে অন্য কুয়েরি লিখতে হয়, তখন এটি লাগে।
...
- **Data Integrity:** ডেটা ভুল হওয়ার সম্ভাবনা থাকে না।
- **Reliability:** মাঝপথে এরর আসলে আগের সব পরিবর্তন মুছে যায় (Rollback)।
- **Performance:** অনেক ক্ষেত্রে আলাদা আলাদা রিকোয়েস্ট পাঠানোর চেয়ে ট্রানজ্যাকশন দ্রুত হয়।
